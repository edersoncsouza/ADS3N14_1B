...
class Test {
    ...
    private AvlTree2<Integer> tree = new AvlTree2<Integer>();
    ...
    private boolean checkBalanceOfTree(AvlTree2.AvlNode<Integer> current) {
    ...
    private int getDepth(AvlTree2.AvlNode<Integer> n) {
        int leftHeight = 0, rightHeight = 0;
    ...
    private boolean checkOrderingOfTree(AvlTree2.AvlNode<Integer> current) {
        if(current.left != null) {
...
*/
	 ...
	 */
	public static void performInsertions(AvlTree2<Integer> t){
		Random r = new Random();
		int range = 500;
		int count = 100;
		Integer x;				
